...
import 'package:gimatex/data_tables/color_coding.dart';
import 'package:gimatex/data_tables/color_order_req.dart';
import 'package:gimatex/data_tables/finstock_detail.dart';
import 'package:gimatex/data_tables/rawstore_detail.dart';
import 'package:gimatex/data_tables/rawstore_total.dart';
import 'package:gimatex/data_tables/underProcess.dart';
            ...
            child: Container(
              decoration: BoxDecoration(
                gradient: const LinearGradient(
                  colors: [Color(0xff4053a1), kMainColor],
                  ...
                  TextButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const ColorOrderReq(),
                          ),
                        );
                      },
                      child: const Text(
